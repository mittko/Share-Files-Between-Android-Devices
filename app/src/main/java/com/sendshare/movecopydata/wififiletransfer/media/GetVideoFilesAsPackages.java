...
public class GetVideoFilesAsPackages extends AsyncTask<Void,Void, HashMap<String, ArrayList<String>>> {

    private WeakReference<Context> contextWeakReference;
    private ListRefresher3 listRefresher3;
    private HashMap<String, ArrayList<String>> map =
            new HashMap<>();
    public GetVideoFilesAsPackages(Context context) {
        this.contextWeakReference = new WeakReference<>(context);
    }
    public GetVideoFilesAsPackages(Context context,ListRefresher3 listRefresher3) {
        this.contextWeakReference = new WeakReference<>(context);;
    ...
    protected HashMap<String, ArrayList<String>> doInBackground(Void... voids) {
       ...
       //     MyConsole.println("absolute path = " + absolutePathOfImage);
