...
public class FileReceiverThreadSdCardWorksPerfectly extends Thread { // CUSTOM DIRECTORY
        ...
        public FileReceiverThreadSdCardWorksPerfectly(WeakReference<Context> weakReference, Socket socket, Uri persistableUri,
