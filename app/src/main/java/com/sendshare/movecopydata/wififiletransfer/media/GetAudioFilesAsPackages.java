...
public class GetAudioFilesAsPackages extends AsyncTask<Void,Void, HashMap<String, ArrayList<String>>> {
    ...
    public GetAudioFilesAsPackages(Context context, ListRefresher3 listRefresher3) {
    ...
    protected HashMap<String, ArrayList<String>> doInBackground(Void... voids) {
      ...
      /*
        !!! ВАЖНО
        In API verions <= 28 BUCKET_DISPLAY_NAME only exists for images and videos
        BUCKET_DISPLAY_NAME. It is added in API 29. Before this we were using DISPLAY_NAME for API 28 & below.
        For solution you can write conditions according to current API level
      */
      String bucketName = null;
      if(Build.VERSION.SDK_INT <= 28) {
          bucketName = MediaStore.Audio.Media.DISPLAY_NAME;
      } else {
          bucketName = MediaStore.Audio.Media.BUCKET_DISPLAY_NAME;
      }
